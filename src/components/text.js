export const activitiesList = [{
    name: "Bij een paar bomen zie je berkenzwammen, ze zijn erg mooi maar wat zal dit betekenen voor de bomen?",
    type: "quiz",
    choices: {
      "Houtrot": {
        correct: true,
  ...
  {
    name: "Bossen worden wel eens de groene longen van onze aarde genoemd. Waarom is dat?",
    type: "quiz",
    choices: {
  ...
  {
    name: "Waarmee kun je de meeste CO2 uitstoot besparen?",
    type: "quiz",
    choices: {
